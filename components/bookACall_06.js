...
export default function BookACall_06() {
            ...
            <section className="flex flex-col lg:py-12 lg:px-0  p-12 lg:mx-auto lg:max-w-7xl">
                ...
                <div className="py-4">
                    <div className="text-xl text-gray.700 font-medium">
                        Did you know that long-lasting and desperately needed societal change can be brought about by empowering women to become leaders and entrepreneurs?
                    </div>
                </div>
                <div className="">
