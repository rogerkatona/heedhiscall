        ...
        <div className="flex flex-col">
            <div className="flex max-w-7xl mx-auto lg:px-0 md:px-12 px-4 lg:flex-row-reverse flex-col">
                ...
                <div className="lg:w-5/6 w-full">
                    ...
                    <p className="p-4 pt-6">Traditions of society often encourage “responsible” adults to suppress their individual dreams and distinctive gifts. By doing so, we are told that the sacrifice of ourselves will result in greater good for our family, friends, and society as a whole. We are not told, however, that setting aside our unique selves puts us in a minimalistic, tightly controlled box. Our dreams go unfulfilled, our unique strengths are weakened, and the quality of our lives is diminished.
                    </p>
                </div>
            </div>
        </div>
